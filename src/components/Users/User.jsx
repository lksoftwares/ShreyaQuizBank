...
export default function User() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      !formDataa.user_Name ||
      !formDataa.user_Email ||
      !formDataa.user_Password
    ) {
      toast.error("All fields are required.");
      setHighlightedFields({
        user_Name: !formDataa.user_Name,
        user_Email: !formDataa.user_Email,
        user_Password: !formDataa.user_Password,
      });
      setLoading(false);
      return;
    }
    ...
    if (!emailPattern.test(formDataa.user_Email)) {
    ...
    try {
      ...
      if (response.data.dup === true) {
        ...
        setIsOpen(false);
        console.log("response.data", response.data);
        setFormDataa({}); // Clear the form data
      }
    } catch (err) {
        ...
        >
          ...
          <input
            ...
            className={`mar inputt ${
              highlightedFields.user_Name ? "highlight" : ""
            }`}
          ...
          <input
            type="email"
            className={`mar inputt ${
              highlightedFields.user_Email ? "highlight" : ""
            }`}
          ...
          <input
            type="text"
            className={`mar inputt ${
              highlightedFields.user_Password ? "highlight" : ""
            }`}
